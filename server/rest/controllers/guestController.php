...
class guestController extends Controller {
    ...
    public function get_mercadopago()
    {
      ...
      $preference_data = array(
        ...
        'email' => Bootstrap::$main->user['email'],
          ...
          "back_urls" => array (
            'success'=>Bootstrap::$main->getConfig('protocol').'://'.$_SERVER['HTTP_HOST'].Bootstrap::$main->getRoot().'guest/mercadopagoresult',
    ...
    {
      Tools::log('mercadopago',['return',$_SERVER['REQUEST_URI'],$this->data]);
      $config=Bootstrap::$main->getConfig();
      ...
      $this->redirect($config['app.root'].'profile#guest');
